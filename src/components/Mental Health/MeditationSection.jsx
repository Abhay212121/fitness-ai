...
import { motion } from "framer-motion";
import { Brain, Clock, Users, Award, Play } from "lucide-react";
  ...
  const meditationTypes = [
    {
      ...
      videoUrl: "https://youtu.be/fcRANlaqf9c?si=P1gG79AuiWQ7YyWN",
    },
    {
      name: "Sleep Meditation",
      duration: "10-15 min",
      image:
        "https://plus.unsplash.com/premium_photo-1688464908068-cd8889fc652e?q=80&w=735&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    ...
    },
    {
      ...
      duration: "40-45 min",
      image:
        "https://plus.unsplash.com/premium_photo-1672115680958-54438df0ab82?q=80&w=1184&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      videoUrl: "https://www.youtube.com/watch?v=fY9vX3YpI-M",
    },
  ];
              ...
              <div className="bg-gray-900/50 border border-gray-800 hover:border-blue-500/50 rounded-lg overflow-hidden transition-all duration-300 font-head hover:scale-102">
                <div className="flex items-center p-4 sm:p-6">
                  ...
                  <a
                    ...
                    className="text-blue-400 hover:text-blue-300 p-2 rounded-md transition-colors cursor-pointer"
                  >
                    <Play className="w-5 h-5" />
                  </a>
                </div>
