...
const Tracking = () => {
  ...
  const tabs = [
    { id: "workout", label: "Workout", icon: Activity, color: "#CE241A" },
    ...
    <>
      ...
      <div className="min-h-screen bg-background pt-16 bg-[#000000] text-white font-head">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-[#A4A7B0] max-w-2xl mx-auto">
                Log your daily workouts, sleep patterns, and emotional
                well-being to stay on track with your health goals.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          {/* Tab Content */}
          {activeTab === "workout" && <WorkoutTracking />}
